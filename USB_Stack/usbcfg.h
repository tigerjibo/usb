...
#define CDC_ACM 			1 // use CDC ACM example  if so enable USB_CLASS & USB_CDC

#define USB_CLASS           CDC_ACM //HACK 1
#define USB_HID             0
...
#define USB_CDC  			CDC_ACM //HACK 1
#define USB_CDC_CIF_NUM     0
#define USB_CDC_DIF_NUM     1
#define USB_CDC_BUFSIZE     64
#define USB_VND_BUFSZIE		64
#define USB_VND_DIF_NUM	 	0
